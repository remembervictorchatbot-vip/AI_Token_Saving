...
Yes, measurably at the tool level - 49.6% aggregate on representative
...
condensed system-prompt bundle for everything else ([[06 - Adapters]]).
...
the deterministic bench. The project's honesty policy: claimed vs measured
is always stated.

**How do I know the install works?**
'toks selftest' runs 132 tests and must stay GREEN (CI enforces this on
...
See also: [[01 - Overview]] (quick start), [[04 - Benchmark]] (numbers).