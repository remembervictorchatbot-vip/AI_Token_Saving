...
The skill is synthesized from three open-source approaches - logic kept,
...
- API-layer knobs (max_tokens, stop sequences, model routing) - not in this
  layer; behavioral rules only.
...
See also: [[02 - Architecture]] (rules in action), [[04 - Benchmark]]
(measured numbers).